...
public class PruebaMundoPc {
    ...
    public static void main(String[] args) {
        ...
        Teclado tecladoHP = new Teclado("bluthoon", "HP");
        Raton ratonHP = new Raton("bluthon", "HP");
        Computadora computadoraHP = new Computadora("Computadora HP", monitorHP, tecladoHP, ratonHP);
        
        Monitor monitorGamer = new Monitor("Gamer", 34);
        Teclado tecladoGamer = new Teclado("bluthoon", "Gamer");
        Raton ratonGamer = new Raton("bluthon", "Gamer");
